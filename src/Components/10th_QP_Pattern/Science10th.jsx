                ...
                <main style={{ flex: "1" }}>
                  ...
                  <div className="question-body mb-2">
                    ...
                    <div>
                      <b style={{ textAlign: "left" }}>
                        {" "}
                        Structure in Column "B" and Characteristic features
                        inColumn 'C'
                      </b>
                    </div>
                  </div>
                ...
                <main style={{ flex: "1" }}>
                  ...
                  <div className="question-body mb-2">
                    ...
                    <div>
                      <div style={{ display: "flex", gap: "12px" }}>
                        <p>19.</p>
                        <p>
                          Draw a neat diagram of a single stage rocket and label
                          the parts.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="question-body mb-2">
                    <div>
                      ...
                      >
                        <p>
                          20. Write the balance chemical equition for the
                          following reaction :{" "}
                        </p>
                      </div>
                      <ol type="i">
                  ...
                  <div className="question-body mb-2">
                    <div>
                      ...
                      >
                        ...
                        <p>
                          {" "}
                          Why does Gandhi say that Alexander' conquests cannot
              ...
              <div className="englishqp-page-body">
                ...
                <main style={{ flex: "1" }}>
                  <div className="question-body mb-2">
                    ...
                    <div className="question-body mb-1">
                      <div>
                        <div className="options">a. Mg + O2 → MgO</div>
                        <div className="options">b. Zn + H2 SO4→ZnSO4</div>
                        <div className="options">c. H2 + O2→H2O</div>
                      </div>
                      <p>
                        {" "}
                    ...
                    <div>
                      ...
                      >
                        <p>
                          ...
                          prefection?
                          <ol type="a">
                            <li>According to the poet,</li>
                            <li>when is life seen in prefection?</li>
                          </ol>
                        </p>
                      </div>
                    </div>
