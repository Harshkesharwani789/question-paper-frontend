...
import { Button, Card, Container, Form, InputGroup, Modal, Row, Table } from 'react-bootstrap'
                ...
                <div className="blueprint-content-display-container">
                    ...
                    <div className="blueprint-content-display" >
                        ...
                        <div className='weightage-objectives'>
                            ...
                            <div className='objectives-table'>
                                <Table bordered hover size="sm" style={{ width: "50%", border:"1px solid" }}>
                                    <tbody>
                                        <tr>
                                            <td>Prose</td>
                                            <td>30</td>
                                        ...
                                        <tr>
                                            <td>Grammer 20 + <br></br> Vocabulary</td>
                                            <td><span style={{ borderBottom: "1px solid" }}>33</span> <br></br>100</td>
                                        </tr>
                                    </tbody>
                                </Table>
                        ...
                        <div className='weightage-objectives'>
                            ...
                            <div className='objectives-table'>
                                <Table bordered hover size="md" style={{ width: "70%" , border:"1px solid"}} >
                                    <tbody>
                                        <tr>
                    ...
                    <div style={{display:"flex", justifyContent:"flex-end", padding:"10px"}}>
                       <a href='/questionpaper'><Button variant='' style={{backgroundColor:"navy", color:"white"}}>Generate Question Paper</Button></a> 
                    </div>
                </div>
