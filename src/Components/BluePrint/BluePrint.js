...
const BluePrint = () => {
    ...
    return (
        <div>
            <div style={{ backgroundColor: "aliceblue", position: "sticky", top: "0px" }}>

                <div>
                    <div>
                        <div style={{ fontSize: "22px", textAlign:"center" }}>Section-A</div>
                    ...
                    <div className="blueprint-box" >
                        <div style={{ display: "flex", gap: "20px", backgroundColor: "white", borderRadius: "15px", justifyContent: "space-between", background: "white ", border: "1px solid lightgray", width: "100%", padding: "0 20px" }}>
                            <div className='card-container'>
                                <div className="card" style={{ width: "100%", border: "none" ,boxShadow: "none"}}>
                                    <div className="card-body" style={{ textAlign: "left" }}>
                                        <h6 className="card-title">Question Number - 1</h6>
                                        <h6 className="card-title"> <b>Circle</b></h6>
                            ...
                            <div className='button-container' >
                                <div style={{ margin: "10px 0" }}>
                                    <Button variant='' className='edit-button' onClick={handleShow}>Edit</Button>
                                </div>
                                <div style={{ margin: "10px 0" }}>
                                    <Button variant='' className='Add-button' onClick={handleShow1}>Add Internal Question</Button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div className="blueprint-box">
                        <div style={{ display: "flex", gap: "20px", justifyContent: "space-between", border: "1px solid lightgray", width: "100%", padding: "0 20px", background: "#dfdfdf", borderRadius: "15px" }}>
                            <div className='card-container'>
                                <div className="card" style={{ width: "100%", border: "none", backgroundColor: "#dfdfdf" }}>
                                    <div className="card-body" style={{ textAlign: "left" }}>
                                        <h6 className="card-title">Question Number - 1</h6>
                                        <h6 className="card-title"> <b>Circle</b></h6>
                                        <h6>Multiple Choise Question</h6>
                    ...
                    <div className="blueprint-box">
                        <div style={{ display: "flex", gap: "20px", justifyContent: "space-between", border: "1px solid lightgray", width: "100%", padding: "0 20px", background: "#dfdfdf", borderRadius: "15px" }}>
                            ...
                            <div className='button-container' >
                                ...
                                <div style={{ margin: "10px 0" }}>
                                    <Button onClick={handleShow1} variant='' className='Add-button'>Add Internal Question</Button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div className="blueprint-box">
                        <div style={{ display: "flex", gap: "20px", justifyContent: "space-between", borderRadius: "15px", background: "white ", border: "1px solid lightgray", width: "100%", padding: "0 20px" }}>
                            <div className='card-container'>
                                <div className="card" style={{ width: "100%", border: "none",boxShadow: "none" }}>
                                    <div className="card-body" style={{ textAlign: "left" }}>
                                        <h6 className="card-title">Question Number - 1</h6>
                ...
                <div>
                    <div className="blueprint-box">
                        <div style={{ display: "flex", gap: "20px", justifyContent: "space-between", border: "1px solid lightgray", width: "100%", padding: "0 20px", background: "#dfdfdf", borderRadius: "15px" }}>
                            <div className='card-container'>
                                <div className="card" style={{ width: "100%", border: "none", borderRadius: "15px", backgroundColor: "#dfdfdf" }}>
                                    <div className="card-body" style={{ textAlign: "left" }}>
                                        <h6 className="card-title">Question Number - 1</h6>
                                        <h6 className="card-title"> <b>Circle</b></h6>
                                        <h6>Multiple Choise Question</h6>
                ...
                <div>
                    <div>
                        <div style={{ fontSize: "22px", textAlign:"center" }}>Section-B</div>
                        <div style={{ display: "flex", justifyContent: "center", gap: "15px", fontSize: "20px" }}>
                            <div>I. </div>
                            <div><b >Header</b></div>
                        </div>
                ...
                <div>
                    <div>
                        <div style={{ fontSize: "22px" ,  textAlign:"center"}}>Section-C</div>
                        <div style={{ display: "flex", justifyContent: "center", gap: "15px", fontSize: "20px" }}>
                            <div>I. </div>
                            <div><b >Header</b></div>
                        </div>
                ...
                <div>
                    <div className="blueprint-box">
                        <div style={{ display: "flex", gap: "20px", justifyContent: "space-between", border: "1px solid lightgray", width: "100%", padding: "0 20px", background: "white", borderRadius: "15px" }}>
                        ...
                        <div className='qp-end-buttons'>
                            ...
                            <div>
                                <select id="fontSelector" onchange="changeFontFamily(this.value)" style={{ padding: "5px 8px", borderRadius: "6px" }}>
                                    ...
                                    <option value="Frank Ruhl Libre, serif">Frank Ruhl Libre, serif</option>
                                    <option value="Indie Flower, cursive">Indie Flower, cursive</option>
                                    <option value="Dancing Script, cursive">Dancing Script, cursive</option>
                                    <option value="Avenir, sans-serif">Avenir, sans-serif</option>
                                    <option value="Baskerville, Baskerville Old Face, Hoefler Text, Garamond, Times New Roman, serif">Baskerville, Hoefler Text, </option>
                            ...
                            <div>
                                ...
                                <Button variant='' style={{ backgroundColor: "green", color: "white" }} >View</Button></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <div className='col-12 mb-4'>
                        ...
                        <input type='text' className='form-control' placeholder='Question : 1' disabled style={{ background: "none" }} />
                    </div>
                    <div className='col-12 mb-4'>
                        <select className='selct-cls'>
                    ...
                    <div className='col-12 mb-4'>
                        ...
                        <input type='text' className='form-control' placeholder='Marks : 1' disabled style={{ background: "none" }} />
                    </div>
                </Modal.Body>
                <Modal.Footer>
