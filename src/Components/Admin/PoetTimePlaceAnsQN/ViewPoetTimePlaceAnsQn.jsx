...
function ViewPoetTimePlaceAnsQn() {
...
/>
                        ...
                        <div className="col-md-6">
                            <div className="do-sear mt-2">
                                <label htmlFor=""> Poem, Time, Place, Writer...</label>
                                <p
                                    className="vi_0"
                                >
                                    Poem, Time, Place, Writer... Will Show
                                </p>
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="do-sear mt-2">
                                ...
                                <div>
                                    <span>_________________________________________________</span><br />
...
<button style={{ float: "right" }}>Add</button>
                ...
                <div className="yoihjij text-center my-2 p-2 ">
                    <Button
                        onClick={() => {
                            window.location.assign("/poettimeplaceansqnlist")
                        }}
            ...
            <Modal show={show} onHide={handleClose} size="lg">
                ...
                <Modal.Footer>
                    ...
                    <Button variant="danger" onClick={() => window.location.assign("/poettimeplaceansqnlist")}>
                        Delete
                    </Button>
                </Modal.Footer>
            </Modal>
...
export default ViewPoetTimePlaceAnsQn