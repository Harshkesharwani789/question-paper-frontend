...
function PoetTimePlaceAnsQnList() {
  ...
  const getAllQuestions = async () => {
    try {
      let res = await axios.get(
        `http://localhost:8001/api/admin/getAllQuestionAdmin/${admin?._id}`,
        {
          headers: {
      ...
      <div className="customerhead p-2 mt-4">
        <div className="d-flex justify-content-between align-items-center">
          ...
          <button
            ...
            onClick={() => {
              navigate("/addpoettimeplaceansqn");
            }}
          >
            Add Questions
          </button>
                  ...
                  <tr key={i}>
                    ...
                    <td>
                      <FaEye
                        color="blue"
                        onClick={() => {
                          navigate(`/viewpoettimeplaceansqn/${val?._id}`);
                        }}
                      />
                    </td>
                      ...
                      <div style={{ display: "flex", gap: "20px" }}>
                        <div>
                          <BiSolidEdit
                            ...
                            onClick={() => {
                              setupdateQuestion();
                              navigate("/editpoettimeplaceansqn");
                            }}
                          />
                        </div>
                        <div>
...
export default PoetTimePlaceAnsQnList;
