    ...
    <div>
      ...
      <div className="customerhead p-2 mt-4">
        <div className="d-flex justify-content-between align-items-center">
          <h2 className="header-c ">Five Sentence Question </h2>
          <button
            className="admin-add-btn"
            onClick={() => {
              navigate("/fivesentenceaddanswer");
            }}
          >
            Add Five Sentence Question Answer
          </button>
        </div>
            ...
            <tbody>
              ...
              <td>
                <FaEye
                  color="blue"
                  onClick={() => {
                    navigate(`/fivesentenceanswerview/`);
                  }}
                />
              </td>
                ...
                <div style={{ display: "flex", gap: "20px" }}>
                  <div>
                    <BiSolidEdit
                      ...
                      onClick={() => {
                        // setupdateQuestion();
                        navigate("/fivesentenceeditanswers");
                      }}
                    />
                  </div>
                  <div>
