      ...
      <div className="customerhead p-2 mt-4">
        <div className="d-flex justify-content-between align-items-center">
          <h2 className="header-c ">
            Add 6 Sentences Questions & Answers
          </h2>
          <button
            className="admin-add-btn"
            onClick={() => {
              navigate("/adminquestion6sentencesadd");
            }}
          >
                ...
                <td>
                  <FaEye
                    ...
                    onClick={() => {
                      ...
                      navigate(`/adminquestion6sentencesview`);
                    }}
                  />
                </td>
                  ...
                  <div style={{ display: "flex", gap: "20px" }}>
                    <div>
                      <BiSolidEdit
                        ...
                        onClick={() => {
                          //   setupdateQuestion();
                          navigate("/adminquestion6sentencesedit");
                        }}
                      />
                    </div>
                    <div>
...
export default QandA_6Sentences