...
const AdminDifficultyLevel = () => {
    ...
    const AddDifficultyLevel = async () => {
      try {
        ...
        return swal({
          title: "Opps!",
          text: "Please Enter the Difficulty level ",
          icon: "error",
          button: "Try Again!",
        });
        const config = {
    ...
    // get method
    const [getDiffiLevel, setDiffiLevel] = useState([]);
    ...
    // edit method
    const [updateDiffLevel, setupdateDiffLevel] = useState("");
    const updateallDiffLevel = async () => {
      try {
        const config = {
    ...
    const records = getDiffiLevel.slice(firstIndex, lastIndex);
    const npages = Math.ceil(getDiffiLevel.length / recordsperpage);
        ...
        <div className="customerhead p-2">
                        ...
                        <div style={{ display: "flex", gap: "20px" }}>
                          <div>
                            <BiSolidEdit
                              ...
                              onClick={() => {
                                handleShow1();
                                setupdateDiffLevel(val);
                                setDiffLevel(val?.DiffLevel);
                              }}
                            />{" "}
                          </div>
                          <div>
          ...
          <Modal show={show} onHide={handleClose} style={{ zIndex: "99999" }}>
            <Modal.Header closeButton>
              <Modal.Title style={{ color: "white" }}>Add Difficulty Level</Modal.Title>
            </Modal.Header>
            <Modal.Body>        
              <div className="row">
                ...
                <div className="do-sear mt-2">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      }else onChangeHandler(e.target.value, setDiffLevel);                    
                    }}
                  />
                   {selectedLanguage == "en-t-i0-und" ? <></> : <p>{DiffLevel}</p>}
                </div>
              </div>
            </Modal.Body>
            <Modal.Footer>
            ...
            <Modal.Body>
              ...
              <div className="do-sear mt-2">
                ...
                <div className="do-sear mt-2">
                  ...
                  <input
                    type="text"
                    placeholder={updateDiffLevel?.DiffLevel}
                    className="vi_0"
          ...
          >
            ...
            <Modal.Footer>
              ...
              <Button variant="" className="modal-add-btn" onClick={deleteDiffLevel}>
                Delete
              </Button>
            </Modal.Footer>
          </Modal>
...
export default AdminDifficultyLevel