...
/>
                ...
                <div className="col-md-6">
                    <div className="do-sear">
                        <label htmlFor="">Image (Situation and Understanding)</label>
                        <input
                            type="file"
                            className="vi_0"
                ...
                <div className="col-md-6">
                        ...
                        {Dash === "1" ? (<>
                            <div className="col-md-6">
                                <label htmlFor=""> Qeestion 1 </label>
                                <input
                                    className="vi_0"
                                    type="text"
                            ...
                            <div className="col-md-6">
                                <label htmlFor="">Write Answer </label>
                                <span style={{ whiteSpace: 'pre-line' }}>_________________________________________________</span><br />
                            </div>
                        </>) : (<> </>)}
                        {Dash === "2" ? (<>
                            <div className="col-md-6">
                            ...
                            <div className="col-md-6">
                                <label htmlFor=""> Qeestion 2 </label>
                                <input
                                    className="vi_0"
                                    type="text"
                                    placeholder="enter text"
                        ...
                        {Dash === "3" ? (<>
                            ...
                            <div className="col-md-6">
                                <label htmlFor=""> Qeestion 3 </label>
                                <input
                                    className="vi_0"
                                    type="text"
                                    placeholder="enter text"
                        ...
                        {Dash === "4" ? (<>
                            ...
                            <div className="col-md-6">
                                <label htmlFor=""> Qeestion 4 </label>
                                <input
                                    className="vi_0"
                                    type="text"
                                    placeholder="enter text"
...
<button style={{ float: "right" }}>Add</button>
        ...
        <div className="yoihjij text-center my-2 p-2 ">
            <Button
                    ...
                    onClick={() => window.location.assign("/understandansqnlist")}
    ...
    <Modal show={show} onHide={handleClose} size="lg">
        <Modal.Header closeButton>
            <Modal.Title>Situation Understanding Answer the Question</Modal.Title>
        </Modal.Header>
        <Modal.Body>
            <div>
                <label htmlFor="">Question</label>
        ...
        <Modal.Footer>
            ...
            <Button variant="danger" onClick={() => window.location.assign("/understandansqnlist")}>
                Delete
            </Button>
        </Modal.Footer>
    </Modal>
...
export default EditUnderstandAnsQN