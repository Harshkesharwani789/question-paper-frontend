...
/>
            ...
            <div className="col-md-6">
              <div className="do-sear mt-2">
                <label htmlFor=""> Question</label>
                <p className="vi_0">No. Of Question Will Show ex 1</p>
              </div>
            </div>

            <div className="col-md-6">
              <label htmlFor=""> Qeestion 1 </label>
              <p className="vi_0"> Qeestion 1 will show</p>
            </div>
            <div className="col-md-6">
            ...
            <div className="col-md-6">
              <div className="do-sear mt-2">
                ...
                <p className="vi_0" onChange={(e) => setMarks(e.target.value)}>
                  Marks Will Show
                </p>
              </div>
            </div>
            <div className="col-md-6">
              <div className="do-sear">
                ...
                <p className="vi_0">1/2 Mnt WIll Show</p>
              </div>
            </div>
            <div className="col-md-12">
              <div className="do-sear mt-2">
                <div className="do-sear mt-2">
                  ...
                  <p className="vi_0">Answer 1 will Show</p>
                </div>
              </div>
            </div>
...
export default ViewUnderstandAnsQN;
