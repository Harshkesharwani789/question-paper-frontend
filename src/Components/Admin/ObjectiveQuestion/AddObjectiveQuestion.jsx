            ...
            <div className="box_1">
                <div className="container">
                    ...
                    <div className="row mt-2">
                        ...
                        <h3 style={{ textAlign: "center" }} className="mt-4">==: Objective Questions :==</h3>
                        ...
                        <div className="col-md-2 mb-4 d-flex justify-content-center align-items-center">
                            <div className="">
...
<button style={{ float: "right" }}>Add</button>
            ...
            <Modal show={show} onHide={handleClose} size="lg">
                ...
                <Modal.Footer>
                    ...
                    <Button variant="danger" onClick={() => window.location.assign("/grammerquestionlist")}>
                        Delete
                    </Button>
                </Modal.Footer>
            </Modal>
...
export default AddObjectiveQuestion