                        ...
                        <div className="blueprint-content-display" >
                            <div className="blueprint-titles">
                                ...
                                <div className="d-flex justify-content-center">
                                    <input
                                        style={{ width: "80px" }} type="text" placeholder="Blue Print"
                                        onChange={(e) => {
                                    ...
                                    />
                                    {selectedLanguage == "en-t-i0-und" ? <></> : <p>{BluePrintName}</p>}
                                </div>
                            </div>
                                ...
                                <div className="row">
                                    <div className="col-md-7">
                                        ...
                                        <div className="weightage-objectives">
                                            <div className="main-title">
                                                <b>1.</b>
                                                <input type="text" placeholder="Unit wise marks allocation"
                                                    onChange={(e) => {
                                                        if (selectedLanguage == "en-t-i0-und") {
                                                ...
                                                />
                                                {selectedLanguage == "en-t-i0-und" ? <></> : <p>{UnitWiseMrk}</p>}
                                            </div>
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <th>
                                                                ...
                                                                {selectedLanguage == "en-t-i0-und" ? <></> : <p>{SNo}</p>}
                                                            </th>
                                                            <th>
                                                                <input
                                                                    onChange={(e) => {
                                                                    ...
                                                                    }} style={{ width: "100px" }} type="text" placeholder="Lessons" />
                                                                {selectedLanguage == "en-t-i0-und" ? <></> : <p>{Lessons}</p>}
                                                            </th>
                                                            <th>
                                                                <input
                                                                    onChange={(e) => {
                                                                    ...
                                                                    }} style={{ width: "80px" }} type="text" placeholder="Questions" />
                                                                {selectedLanguage == "en-t-i0-und" ? <></> : <p>{Questions}</p>}
                                                            </th>
                                                            <th>
                                                                <input
                                                                    onChange={(e) => {
                                                            ...
                                                            <th>
                                                                <input
                                                                    ...
                                                                    }} style={{ width: "80px" }} type="text" placeholder="Percentage" />
                                                                {selectedLanguage == "en-t-i0-und" ? <></> : <p>{Percentage}</p>}
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input
                                                                    ...
                                                                    }} style={{ width: "80px" }} type="text" placeholder="Total" />
                                                                {selectedLanguage == "en-t-i0-und" ? <></> : <p>{Total}</p>}
                                                            </td>
                                                            <td></td>
                                                            <td>
                                                                <b>
                                    ...
                                    <div className="col-md-5">
                                        ...
                                        <div className="weightage-objectives">
                                            <div className="main-title">
                                                <b>2.</b>
                                                <input type="text" placeholder="According to objective Marks Allotment"
                                                    onChange={(e) => {
                                                        if (selectedLanguage == "en-t-i0-und") {
                                                ...
                                                />
                                                {selectedLanguage == "en-t-i0-und" ? <></> : <p>{ObjectiveMrks}</p>}
                                            </div>
                                            <div className="objectives-table">
                                                <Table
                                                    responsive
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>
                                                                <input
                                                                    ...
                                                                    }} style={{ width: "100px" }} type="text" placeholder="Specifics" />
                                                                {selectedLanguage == "en-t-i0-und" ? <></> : <p>{Specifics}</p>}
                                                            </th>
                                                            <th>
                                                                <input
                                                                    onChange={(e) => {
                                        ...
                                        <div className="weightage-objectives">
                                            <div className="main-title">
                                                <b>3.</b>
                                                <input type="text" placeholder="Question wise mark allocation"
                                                    onChange={(e) => {
                                                        if (selectedLanguage == "en-t-i0-und") {
                                                ...
                                                />
                                                {selectedLanguage == "en-t-i0-und" ? <></> : <p>{QuestionWiseMrk}</p>}
                                            </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th>
                                                                    <input
                                                                        ...
                                                                        }} style={{ width: "100px" }} type="text" placeholder="TypeOfQuestion" />
                                        ...
                                        <div className="weightage-objectives">
                                            <div className="main-title">
                                                <b>4.</b>
                                                <input type="text" placeholder="According to rigor Marks distribution"
                                                    onChange={(e) => {
                                                        if (selectedLanguage == "en-t-i0-und") {
                                                ...
                                                />
                                                {selectedLanguage == "en-t-i0-und" ? <></> : <p>{AccordingRigorMrk}</p>}
                                            </div>
                                            <div className="objectives-table">
                                                <Table
                                                    responsive
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>
                                                                <input
                                                                    ...
                                                                    }} style={{ width: "100px" }} type="text" placeholder="LevelOfDifficult" />
                                                                {selectedLanguage == "en-t-i0-und" ? <></> : <p>{LevelOfDifficult}</p>}
                                                            </th>
                                                            <th>
                                                                <input
                                                                    onChange={(e) => {
                                ...
                                <div style={{ display: "flex", justifyContent: "space-between" }}>
                                    <div>
                                        <input
                                            ...
                                            }} style={{ width: "80px" }} type="text" placeholder="Time" />:<b>10 Minuts</b>
                                    ...
                                    <div>
                                        <input
                                            ...
                                            }} style={{ width: "80px" }} type="text" placeholder="BluePrint" />:<b>10 Minuts</b>
                                        {selectedLanguage == "en-t-i0-und" ? <></> : <p>{BluePrintName}</p>}
                                    </div>
                                    <div>
                                        <input
                                            ...
                                            }} style={{ width: "80px" }} type="text" placeholder="Marks" />:<b>10 Minuts</b>
                                        {selectedLanguage == "en-t-i0-und" ? <></> : <p>{Marks}</p>}
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                <th>
                                                    <input
                                                        ...
                                                        }} style={{ width: "80px" }} type="text" placeholder="SNo" />
                                                    {selectedLanguage == "en-t-i0-und" ? <></> : <p>{SNo}</p>}
                                                </th>
                                                <th>
                                                    <input
                                                        ...
                                                        }} style={{ width: "100px" }} type="text" placeholder="TargetUnit" />
                                                    {selectedLanguage == "en-t-i0-und" ? <></> : <p>{TargetUnit}</p>}
                                                </th>
                                                ...
                                                <th colSpan={6}>
                                                    <input
                                                        ...
                                                        }} style={{ width: "100px" }} type="text" placeholder="TotalQuestion" />
                                                ...
                                                <th colSpan={1}>
                                                    <input
                                                        ...
                                                        }} style={{ width: "100px" }} type="text" placeholder="TotalMarks" />
                                                    {selectedLanguage == "en-t-i0-und" ? <></> : <p>{TotalMarks}</p>}
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr style={{ borderBottom: "2px solid black" }}>
                                                ...
                                                <th>
                                                    <input
                                                        ...
                                                        }} style={{ width: "80px" }} type="text" placeholder="D" />
                                                    {selectedLanguage == "en-t-i0-und" ? <></> : <p>{D}</p>}
                                                </th>
                                            </tr>
                                            <tr>
                                                <th></th>
                                                ...
                                                <th>
                                                    <input
                                                        ...
                                                        }} style={{ width: "80px" }} type="text" placeholder="VSA" />
                                                    {selectedLanguage == "en-t-i0-und" ? <></> : <p>{VSA}</p>}
                                                </th>
                                                <th>
                                                    <input
                                                        onChange={(e) => {
                                                        ...
                                                        }} style={{ width: "80px" }} type="text" placeholder="SA" />
                                                    {selectedLanguage == "en-t-i0-und" ? <></> : <p>{SA}</p>}
                                                </th>
                                                <th>
                                                    <input
                                                        onChange={(e) => {
                                                        ...
                                                        }} style={{ width: "80px" }} type="text" placeholder="LA1" />
                                                    {selectedLanguage == "en-t-i0-und" ? <></> : <p>{LA1}</p>}
                                                </th>
                                                <th>
                                                    <input
                                                        onChange={(e) => {
                                                        ...
                                                        }} style={{ width: "80px" }} type="text" placeholder="LA2" />
                                                    {selectedLanguage == "en-t-i0-und" ? <></> : <p>{LA2}</p>}
                                                </th>
                                                <th>
                                                    <input
                                                        onChange={(e) => {
                                                        ...
                                                        }} style={{ width: "80px" }} type="text" placeholder="LA3" />
                                                    {selectedLanguage == "en-t-i0-und" ? <></> : <p>{LA3}</p>}
                                                </th>
                                                <th></th>
                                            </tr>
                                    ...
                                    <div>
                                        <span>
                                            <input
                                                ...
                                                }} style={{ width: "80px" }} type="text" placeholder="Note" />:-
                                            {selectedLanguage == "en-t-i0-und" ? <></> : <p>{Note}</p>}
                                        </span>
                                        <p>Blue Print Instruction</p>
                                    </div>
                                    <button onClick={AddBluePrintHeader} className="admin-add-btn mt-4">Add Headers</button>
                                </div>
