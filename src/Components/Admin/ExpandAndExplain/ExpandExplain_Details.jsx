    ...
    <>
      ...
      <div className="customerhead p-2 mt-4">
        <div className="d-flex justify-content-between align-items-center">
          <h2 className="header-c ">Add Expand & Explain Questions</h2>
          <button
            className="admin-add-btn"
            onClick={() => {
              navigate("/adminexpandexplainadd");
            }}
          >
                ...
                <td>
                  <FaEye
                    ...
                    onClick={() => {
                      ...
                      navigate(`/adminexpandexplainview`);
                    }}
                  />
                </td>
                  ...
                  <div style={{ display: "flex", gap: "20px" }}>
                    <div>
                      <BiSolidEdit
                        ...
                        onClick={() => {
                          //   setupdateQuestion();
                          navigate("/adminexpandexplainedit");
                        }}
                      />
                    </div>
                    <div>
...
export default ExpandExplain_Details;
