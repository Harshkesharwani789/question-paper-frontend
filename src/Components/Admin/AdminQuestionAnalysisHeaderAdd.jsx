                                    ...
                                    <div>
                                        <span>
                                            <input
                                                ...
                                                }} style={{ width: "50rem" }} type="text" placeholder="Note" />:-
                                            {selectedLanguage == "en-t-i0-und" ? <></> : <p>{Note}</p>}
                                        </span>
                                        <p>Questions Analysis Instruction</p>
                                    </div>
                                    <button onClick={AddQuestAnalysisHeader} className="admin-add-btn mt-4">Add Headers</button>
                                </div>
                                  </div>
                              </div>
                          </div>
