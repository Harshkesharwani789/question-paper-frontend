          ...
          <div id="pdf">
            <div className="blueprint-content-display">
              <div className="blueprint-titles">
                <h3>Edit Blue Print</h3>
                <div className="d-flex justify-content-center">
                  <input
                    style={{ width: "80px" }}
                    type="text"
                    placeholder={item?.BluePrintName}
                    onChange={(e) => {
                  ...
                  <div className="col-md-5">
                    ...
                    <div className="weightage-objectives">
                      <div className="main-title">
                        ...
                        <input
                          type="text"
                          placeholder={item?.ObjectiveMrks}
                          onChange={(e) => {
                            if (selectedLanguage == "en-t-i0-und") {
                    ...
                    <div className="weightage-objectives">
                      <div className="main-title">
                        ...
                        <input
                          type="text"
                          placeholder={item?.QuestionWiseMrk}
                          onChange={(e) => {
                            if (selectedLanguage == "en-t-i0-und") {
                              ...
                              <tr>
                                ...
                                <th>
                                  <input
                                    ...
                                    style={{ width: "100px" }}
                                    type="text"
                                    placeholder={item?.TypeOfQuestion}
                                  />
                                  {selectedLanguage == "en-t-i0-und" ? (
                                    <></>
                                  ) : (
                              ...
                              <tr>
                                ...
                                <td>
                                  <input
                                    ...
                                    style={{ width: "100px" }}
                                    type="text"
                                    placeholder={item?.Objectivequestion}
                                  />
                                  {selectedLanguage == "en-t-i0-und" ? (
                                    <></>
                                  ) : (
                    ...
                    <div className="weightage-objectives">
                      <div className="main-title">
                        ...
                        <input
                          type="text"
                          placeholder={item?.AccordingRigorMrk}
                          onChange={(e) => {
                            if (selectedLanguage == "en-t-i0-und") {
                            ...
                            <tr>
                              ...
                              <th>
                                <input
                                  ...
                                  style={{ width: "100px" }}
                                  type="text"
                                  placeholder={item?.LevelOfDifficult}
                                />
                                {selectedLanguage == "en-t-i0-und" ? (
                                  <></>
                                ) : (
                      ...
                      <tr>
                        ...
                        <th colSpan={6}>
                          <input
                            ...
                            style={{ width: "100px" }}
                            type="text"
                            placeholder={item?.TotalQuestion}
                          />
                          {selectedLanguage == "en-t-i0-und" ? (
                            <></>
                          ) : (
