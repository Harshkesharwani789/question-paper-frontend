    ...
    <div className="do-sear mt-2">
      ...
      />
            ...
            <div className="col-md-3">
              ...
              <p className="vi_0">Dash Will Show 1</p>
            </div>

            <div className="col-md-9 d-flex align-items-end ">
              <p className="vi_0"> First test Will Show</p>
              <span>___________</span>
              <p className="vi_0">Last Text Will Show</p>
            </div>

            <div className="col-md-6">
              <div className="do-sear mt-2">
                <label htmlFor=""> Marks</label>
                <p className="vi_0">1 Will Show</p>
              </div>
            </div>
            <div className="col-md-6">
              <div className="do-sear">
                <label htmlFor="">Answer Time</label>
                <p className="vi_0">1/2 Mnt Will</p>
              </div>
            </div>
...
export default ViewGrammerQuestion;
