      ...
      <div className="customerhead p-2 mt-4">
        <div className="d-flex justify-content-between align-items-center">
          <h2 className="header-c ">
            Add 7 Sentences Questions & Answers
          </h2>
          <button
            className="admin-add-btn"
            onClick={() => {
              navigate("/adminquestion7sentencesadd");
            }}
          >
                ...
                <td>
                  <FaEye
                    ...
                    onClick={() => {
                      ...
                      navigate(`/adminquestion7sentencesview`);
                    }}
                  />
                </td>
                  ...
                  <div style={{ display: "flex", gap: "20px" }}>
                    <div>
                      <BiSolidEdit
                        ...
                        onClick={() => {
                          //   setupdateQuestion();
                          navigate("/adminquestion7sentencesedit");
                        }}
                      />
                    </div>
                    <div>
...
export default QandA_7Sentences