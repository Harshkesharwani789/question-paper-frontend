  ...
  return (
    <div>
          ...
          <div className="box">
            <div className="row">
              <div className="col-md-6">
                <div
                  style={{
                    backgroundImage: "url('../page2bg.png')",
                ...
                >
                  <h3 style={{ padding: "20px" }}>Guru Resource Management</h3>
                </div>
              </div>
              <div className="col-6">
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <div>
            <img src="../razorpay.png" style={{ width: "150px" }} alt="" />
          </div>
        </Modal.Body>
        <Modal.Footer>
        ...
        <Modal.Body>
          <div>
            ...
            <div className="col-12 mb-3">
              <label>Class :</label>
              <br />
              <input className="form-control" placeholder="Enter Class Name" />
            </div>
