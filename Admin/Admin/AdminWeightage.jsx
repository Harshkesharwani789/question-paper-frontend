...
const AdminWeightage = () => {
  ...
  return (
    ...
    <div className="d-flex justify-content-between align-items-center">
      <h2 className="header-c ">Weightage</h2>
      <button
        className=" btn"
    ...
    <Modal show={show} onHide={handleClose}>
      <Modal.Header closeButton style={{ backgroundColor: "#26AAE0" }}>
        <Modal.Title style={{ color: "white" }}>Add Weightage</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <div className="row">
          <div className="do-sear mt-2">
            <label>Weightage</label>
            <input type="text" placeholder="Enter Weightage" className="vi_0" />
          </div>
        </div>
...
{/* <div className="do-sear mt-2">
    ...
    >
      <Modal.Header style={{ backgroundColor: "rgb(40 167 223)" }}>
        <Modal.Title style={{ color: "white" }}>Edit Weightage</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <div className="row">
          <div className="do-sear mt-2">
