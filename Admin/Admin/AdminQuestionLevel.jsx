  ...
  return (
    ...
    <Modal show={show} onHide={handleClose}>
      <Modal.Header closeButton style={{ backgroundColor: "#26AAE0" }}>
        <Modal.Title style={{ color: "white" }}>Add Question Level</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <div className="row">
          <div className="do-sear mt-2">
            <label>Question Level</label>
            <input type="text" placeholder="Enter Question Level" className="vi_0" />
          </div>
        </div>
...
{/* <div className="do-sear mt-2">
    ...
    >
      <Modal.Header style={{ backgroundColor: "rgb(40 167 223)" }}>
        <Modal.Title style={{ color: "white" }}>Edit Question Level</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <div className="row">
          <div className="do-sear mt-2">
