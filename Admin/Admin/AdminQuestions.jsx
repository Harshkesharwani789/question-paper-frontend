...
const AdminQuestions = () => {
  ...
  return (
    ...
    <div className="d-flex justify-content-between align-items-center">
      <h2 className="header-c ">Questions</h2>
      <button
        className=" btn"
    ...
    <Modal show={show} onHide={handleClose}>
      <Modal.Header closeButton style={{ backgroundColor: "#26AAE0" }}>
        <Modal.Title style={{ color: "white" }}>Add Questions</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <div className="row">
          <div className="do-sear mt-2">
            <label>Questions</label>
            <input type="text" placeholder="Enter Questions" className="vi_0" />
          </div>
        </div>
...
{/* <div className="do-sear mt-2">
    ...
    >
      <Modal.Header style={{ backgroundColor: "rgb(40 167 223)" }}>
        <Modal.Title style={{ color: "white" }}>Edit Questions</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <div className="row">
          <div className="do-sear mt-2">
