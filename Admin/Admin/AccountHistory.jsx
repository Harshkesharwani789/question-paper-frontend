    ...
    return (
        ...
        <Modal.Header closeButton style={{ backgroundColor: "#26AAE0" }}>
            <Modal.Title style={{ color: "white" }}>Add Account History</Modal.Title>
        </Modal.Header>
        <Modal.Body>
            <div className="row">
            ...
            <div className="do-sear mt-2">
                ...
                <input type="text" placeholder="Enter Booking Id" className="vi_0" />
            </div>
            <div className="do-sear mt-2">
                <label>Payment Mode</label>
                <input type="text" placeholder="Enter Payment Mode" className="vi_0" />
            </div>
            <div className="do-sear mt-2">
                <label>Payment ID</label>
                <input type="text" placeholder="Enter Payment Id" className="vi_0" />
            </div>
            <div className="do-sear mt-2">
    ...
    {/* <div className="do-sear mt-2">
        ...
        <div className="row">
            <div className="do-sear mt-2">
                ...
                <input type="text" placeholder="Enter Registration ID" className="vi_0" />
            </div>
            <div className="do-sear mt-2">
                <label>Registration Date</label>
                <input type="text" placeholder="Enter Registration Date" className="vi_0" />
            </div>
            <div className="do-sear mt-2">
                <label>Mobile Number</label>
                <input type="text" placeholder="Enter Mobile Number" className="vi_0" />
            </div>
            <div className="do-sear mt-2">
                <label>Email ID</label>
                <input type="text" placeholder="Enter Email Id" className="vi_0" />
            </div>
            </div>
